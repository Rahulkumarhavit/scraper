...
import UserAvailableCreditsBadage from './UserAvailableCreditsBadage'
...
export function MobileSidebar() {
    ...
    return <div className='block border-separate bg-background md:hidden'>
        <nav className='container flex items-center justify-center justify-between px-8'>
